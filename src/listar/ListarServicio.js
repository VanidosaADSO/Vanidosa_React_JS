    ...
    return (
        <>
            ...
            <div class="content-title-list">
                <h2 class="main-title text-center">LISTAR SERVICIOS </h2>
                    ...
                    <div class="content-table">
                        <table class="main-table table table-bordered">
                            <tr>
                                ...
                                <th class="space text-center">Tipo de servicio</th>
                                <th class="space text-center">Hora</th>
                                <th class="space text-center">Fecha</th>
                                <th class="space text-center">Descripción</th>
                            ...
                            <tr>
                                ...
                                <td class="space">Corte de cabello </td>
                                <td class="space">09:00 </td>
                                <td class="space">10/09/2021</td>
                                <td class="space">Segun las recomendaciones del cliente </td>
                                <td class="space">Activo</td>
                                <td class="space action d-flex justify-content-center">
                                    <div class="content-icon-action">
                                        <a href="/modificarServicio"><img class="edit" src={edit}
                                                alt="" /></a>
